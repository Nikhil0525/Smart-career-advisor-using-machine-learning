...
def result():
    if request.method == 'POST':
        ...
        confidence_scores = np.sort(probs[0])[-3:]
        confidence_scores = [round(score * 100, 2) for score in confidence_scores]
        ...
        var2=res[1][0],
        var3=res[2][0],
        score1=confidence_scores[2],
        score2=confidence_scores[1],
        score3=confidence_scores[0]
        )
